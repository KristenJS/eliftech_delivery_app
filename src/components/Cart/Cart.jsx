...
const Cart = () => {
  ...
  // const googleMapsApiKey = "AIzaSyDSV6V0g6exsNU66Kjdi9Q8FpHHUUWfCuY";
  ...
  // let YOUR_MAP_ZOOM_LEVEL = 10;
  // let SELECTED_LATITUDE = 50.4501;
  // let SELECTED_LONGITUDE = 30.5234;
  // let SHOP_LATITUDE = 50.450432;
  // let SHOP_LONGITUDE = 30.523747;
  ...
  return (
    <div className={style.container}>
      <div className={style.wrapper}>
        <div className={style.block_info}>
          {/* <LoadScript googleMapsApiKey={googleMapsApiKey}>
            <GoogleMap
              center={{ lat: KYIV_LATITUDE, lng: KYIV_LONGITUDE }}
              zoom={YOUR_MAP_ZOOM_LEVEL}
              mapContainerStyle={{
                width: "100%",
                height: "250px",
                marginBottom: "20px",
            ...
            >
              ...
              <Marker position={{ lat: SHOP_LATITUDE, lng: SHOP_LONGITUDE }} />
            </GoogleMap>
          </LoadScript> */}
            ...
            <>
              ...
              <div className={style.block_coupon}>
                ...
                <TextField
                  ...
                  variant="outlined"
                />
                <Button size="small" variant="outlined" onClick={applyCoupon}>
                  Apply
                </Button>
              </div>
            </>
      ...
      <div className={style.block_btn}>
        ...
        {/* <ReCAPTCHA
          sitekey="6LcPCVMmAAAAAKTOObpTZ8raRK3gu3P-5-_SchVS"
